...
module.exports = {
  ...
  //----------------------------- 学生
  //登录注册
  bind_info: data => request(ApiUrlold + 'user/bindinfo/', data), //绑定信息
  get_settings: md => request(ApiUrlold + 'main/get_settings/', md), //获取配置信息
  //首页
  student_login: data => request(ApiUrlold + 'user/wx_login/', data), //登录
  wx_student_login: data => request(ApiUrlold + 'user/wx_student_login/', data), //登录
  mobile_login: data => request(ApiUrlold + 'user/mobile_login/', data), //新登录
  ...
  get_text: data => request(ApiUrlold + 'user/get_text/', data), //绑定邮箱发送错题本
  ...
  change_grade: data => request(ApiUrlold + 'user/change_grade/', data), //修改手机号
  vip_info: data => request(ApiUrlold + 'user/vip/', data), //vip信息
  ...
  send_msg: data => request(ApiUrlold + 'user/send_msg/', data),
  get_download: data => request(ApiUrlold + 'user/download_based/', data),
  ...
  get_verify_code: data => request(ApiUrlold + 'user/get_verify_code/', data), //验证码
  app_pay: data => request(ApiUrlold + 'user/_app_pay/', data), //支付
  get_app_user_edit_password: data => request(ApiUrlold + 'user/edit_password/', data), //学生修改密码
  ...
  teacher_login: data => request(ApiUrlold + 'teacher/wx_teacher_login/', data), //登录
  teacher_logins: data => request(ApiUrlold + 'teacher/wx_login/', data), //登录
  teacher_mobile_login: data => request(ApiUrlold + 'teacher/mobile_login/', data), //登录新
  ...
  teacher_exercise_type: data => request(ApiUrlold + 'teacher/exercises_type/', data), //题型  
  ...
  teacher_bind_info: data => request(ApiUrlold + 'teacher/bindinfo/', data), //绑定信息
  teacher_bind_info_old: data => request(ApiUrlold + 'teacher/bind_info/', data), //绑定信息
  ...
  get_download_based: data => request(ApiUrlold + 'teacher/download_based/', data),
  hot_error_exercises: data => request(ApiUrl + 'applets/teacherAcademicReport/', data), //教师查看学生详情的热门题型
  ter_join_team: data => request(ApiUrlold + 'teacher/join_team/', data), //邀请老师加入班级
  ter_share_login: data => request(ApiUrlold + 'teacher/wx_share_login/', data), //登录
  get_paper: data => request(ApiUrlold + 'teacher/get_paper/', data), //老师获取最新试卷
  get_app_teacher_edit_password: data => request(ApiUrlold + 'teacher/edit_password/', data), //老师修改密码
  techer_search_team: data => request(ApiUrlold + 'teacher/search_team/', data), //搜索班级
  teacher_join_team: data => request(ApiUrlold + 'teacher/join_team/', data), //邀请学生加入班级
  ...
  get_team_location: data => request(ApiUrlold + "main/get_team_location/", data),
  get_wechat_login : data => request(ApiUrlold + 'wechat/login/', data),// 默认执行登录
}
