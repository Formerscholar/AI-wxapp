...
/* 15 */
/*!**************************************************************************!*\
  !*** D:/前端/工作业务/cuotibao/wxapp/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \**************************************************************************/
...
/* 16 */
/*!*******************************************************!*\
  !*** D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue ***!
  \*******************************************************/
/*! no static exports found */
...
/* 17 */
/*!**************************************************************************************!*\
  !*** D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \**************************************************************************************/
...
/* 18 */
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 19 */
/*!********************************************************************************!*\
  !*** D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = { data: function data() {return { title: 'Hello', type: 4, banner_list: '', token: '', teacher_info: {}, student_info: {}, is_vip: '' };}, onLoad: function onLoad() {this.token = uni.getStorageSync('token');if (this.token == '') {uni.navigateTo({ url: '/pages/login/login' });}if (uni.getStorageSync('token') && uni.getStorageSync('type') == 3) {this.get_teacher();}if (uni.getStorageSync('token') && uni.getStorageSync('type') == 4) {this.get_student();}}, onShow: function onShow() {this.type = uni.getStorageSync('type');if (uni.getStorageSync('type') == 3) {uni.setTabBarItem({ index: 1, text: '我的试卷', iconPath: '/static/imgs/icon/myPaper1.png', selectedIconPath: '/static/imgs/icon/myPaper.png' });} else {uni.setTabBarItem({ index: 1, text: '错题本', iconPath: '/static/imgs/icon/cuotiben1.png', selectedIconPath: '/static/imgs/icon/cuotiben.png' });}this.get_banner();console.log(this.type);if (uni.getStorageSync('is_vip')) {this.is_vip = uni.getStorageSync('is_vip');}}, computed: {// ...mapState(['type'])
    ...
    get_teacher: function get_teacher() {var _this3 = this;this.$api.teacher_index({ token: this.token }).then(function (res) {console.log(res);_this3.teacher_info = res.data;});}, get_banner: function get_banner() {var _this4 = this;this.$api.banner({ type: this.type }).then(function (res) {console.log(res);_this4.banner_list = res.data.banner_list;});}, todetail: function todetail(i) {var url = '';if (i == 0) {url = '/pages/myteaching/myteachingPhoto?from=1';} else if (i == 1) {url = '/pages/myteaching/contentReference';} else if (i == 2) {url = '/pages/myPaper/myPaper';} else if (i == 3) {uni.switchTab({ url: '/pages/errorBook/errorBook' });} else if (i == 4) {// url=de_vip(this.is_vip,'学情报告','/pages/learningReport/learningReport')
        url = '/pages/learningReport/learningReport';} else if (i == 5) {url = '';} else if (i == 6) {uni.switchTab({ url: '/pages/errorBook/errorBook' });} else if (i == 7) {url = '/pages/myPaper/myPaper';} else if (i == 8) {url = '/pages/learningReport/j-xueqingbaogao';} else if (i == 9) {if (this.type == 4) {url = (0, _common.de_vip)(this.is_vip, '名校资源', '/pages/myPaper/new_paper');} else {url = '/pages/myPaper/new_paper';}}uni.navigateTo({ url: url });} } };exports.default = _default;
...
/* 22 */
/*!*****************************************************************************************!*\
  !*** D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 23 */
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/前端/工作业务/cuotibao/wxapp/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
