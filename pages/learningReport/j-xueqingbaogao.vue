<template>
	<view>
		<view class="class">
			<view :class="{'b-b':item.team_id==team_id}" v-for="(item,i) of class_list" :key='i' @click="select_class(i)">
				{{item.team_name}}
			</view>
		</view>
		...
		<view class='hotTitle' v-if='exercises_list.length!=0'>
			...
			<view class='hotTitleCon'>
				<image src='//aictb.oss-cn-shanghai.aliyuncs.com/wx_xcx/bg/hot.png'></image><text>热门易错题型</text>
			</view>
