      ...
      <block v-if="update">
        <view class="s-item" v-for="(item, i) in textbook_list" :key="i" @click="select(item)">
          ...
          <view class="infoCon">
            ...
            <view class="type">{{ item.get_version.title }}</view>
          </view>
          <view :class="{ 'b-g': item.status  }" class="default"></view>
        </view>
      </block>
          ...
          <scroll-view class="scroll-view" scroll-y="true">
            <block v-if="update">
              <view class="s-item" v-for="(item, i) in textbook_list" :key="i" @click="select(i)">
                ...
                <view :class="{ 'b-g': item.status }"></view>
              </view>
            </block>
          </scroll-view>
        </view>
        <view class="btnCon"><button class="btn" @click="tochaxun()">确定</button></view>
      </view>
    </uni-popup>
  </view>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      //习题难度
      get_semester() {
        this.$api.get_semester().then(res => {
      ...
      select_l(e) {
        ...
        this.semester = this.semester_list[e.detail.value].key;
        this.open();
      },
      //教辅版本列表
      version() {
