...
<script>
  export default {
    ...
    methods: {
      ...
      chakan(id, title, is_dir) {
        if (is_dir === 1) {
          uni.navigateTo({
            url: '/pages/myPaper/seePapers?based_id=' + id + '&title=' + title + '&subject=' + this.subject_id +
              '&subject_name=' + this.subject_name + '&source=2'
          });
        } else {
          uni.navigateTo({
            url: '/pages/myPaper/new_paper_dir?based_id=' + id + '&title=' + title + '&subject=' + this.subject_id +
              '&subject_name=' + this.subject_name + '&subject_icon=' + this.subject_icon + '&is_mypaper=' + true
          });
        }
      }
    }
